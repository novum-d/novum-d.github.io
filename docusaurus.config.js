    ...
    ({
      ...
      footer: {
        ...
        links: [
          {
            label: "GitHub",
            href: "https://github.com/novum-d",
          },
          {
            label: "Cosence",
            href: "https://scrapbox.io/novumd",
          },
          {
            label: "X",
            href: "https://x.com/DroidParrot",
          },
        ],
        copyright: `&copy; ${new Date().getFullYear()} novumd. All content is the property of novumd and novumd.com.`,
      },
